...
参数布局（共 97 维）::
    ...
    [87:88]     DRC strength 1 (manual 强度 /1023；硬件最强单一维度，
                保真度闸门实测标定，见 docs/isp-param-tuning-research.md §5)
    [88:96]     LDCI 8 (he_pos 3 + he_neg 3 + blc_ctrl + gauss_lpf_sigma)
    [96]        Dehaze 1
"""
...
DIM_DRC_STRENGTH = 1  # manual strength /1023
